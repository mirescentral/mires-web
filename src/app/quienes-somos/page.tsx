...
export default function QuienesSomosPage() {
  ...
  const equipoPastoral = [
    "Patricio Gallardo",
    "Natalia Olivares y César Muñoz",
    "Carolina Soto y Cristian Andaur",
    "Marcos Vega y Geraldine Abarca",
    "Marcelo Flores y Miryam Henríquez",
    "Alejandro Geyssel"
  ];
    ...
    <div className="flex flex-col min-h-screen bg-eden-cream text-eden-black pt-32 font-sans">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-5xl text-center fade-in-up">
          <span className="text-xs font-bold tracking-[0.25em] uppercase text-eden-muted mb-6 block">
            Nuestra Identidad
          </span>
          <h1 className="font-serif text-6xl md:text-8xl lg:text-9xl tracking-tighter leading-[0.95] mb-8">
            Nuestra <br/> Historia.
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
            ...
            <div className="space-y-6">
              ...
              <div className="text-lg font-light text-eden-muted leading-relaxed space-y-4">
                <p>
                  <strong>Alcanzar</strong> a familias y personas que no han tenido una verdadera relación con Cristo.
                </p>
                <p>
                  <strong>Restaurando</strong> el plan original de Dios en sus vidas.
                </p>
                <p>
                  <strong>Consolidando</strong> la vida espiritual de cada integrante.
                </p>
                <p>
                  <strong>Sirviendo</strong> al prójimo por amor a Dios.
                </p>
                <p>
                  <strong>E influyendo</strong> en nuestras comunidades a través de lo que Dios ha hecho en nuestras vidas.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="max-w-3xl mb-20">
            ...
            <p className="text-lg md:text-xl font-light text-eden-stone leading-relaxed">
              En Mires creemos que la fe tiene el poder de transformar vidas, fortalecer familias y generar un impacto positivo en la comunidad. Nuestra convicción está basada en las enseñanzas de la Biblia y en el deseo de crecer espiritualmente, desarrollar una relación más profunda con Dios y compartir esperanza, amor y propósito con quienes nos rodean.
            </p>
            <p className="text-sm font-bold tracking-widest uppercase text-eden-stone mt-8">
              Fundamento de fe:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
            {creencias.map((creencia, index) => (
              <div key={index} className="flex items-start gap-4 border-t border-eden-stone/30 pt-6">
                ...
                <p className="text-sm md:text-base font-light text-eden-stone leading-relaxed">
                  {creencia}
                </p>
              </div>
            ))}
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-start gap-16 border-t border-eden-stone pt-16">
            ...
            <div className="md:w-1/3">
              ...
              <p className="font-light text-sm text-eden-muted leading-relaxed">
                Hombres y mujeres con vocación de servicio, dedicados a guiar, cuidar y edificar a nuestra comunidad con base en los principios bíblicos.
              </p>
            </div>
            ...
            <div className="md:w-2/3 w-full space-y-16">
              ...
              <div>
                <span className="text-xs font-bold tracking-[0.2em] uppercase text-eden-muted mb-4 block border-b border-eden-stone pb-2">
                  Pastores Principales
                </span>
              ...
              <div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-12">
                  {equipoPastoral.map((pastor, index) => (
                    <li key={index} className="font-sans text-lg font-light text-eden-black">
                      {pastor}
                    </li>
                  ))}
                </ul>
