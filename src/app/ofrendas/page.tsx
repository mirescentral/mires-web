    ...
    <div className="flex flex-col min-h-screen bg-eden-black text-eden-white pt-24 md:pt-32">
      ...
      <section className="py-24 md:py-32 px-6 border-b border-eden-white/10">
        <div className="container mx-auto max-w-4xl text-center fade-in-up">
          <span className="font-sans text-xs font-semibold tracking-[0.25em] uppercase text-eden-stone/60 mb-6 block">
            Adoración
          </span>
          <h1 className="font-serif-eden text-6xl md:text-8xl lg:text-9xl mb-8 tracking-tighter leading-[0.95]">
            El acto <br className="hidden md:block"/> de dar.
          </h1>
          <p className="font-sans text-lg md:text-xl text-eden-stone/80 font-light leading-relaxed max-w-2xl mx-auto">
            Creemos que dar es una respuesta natural de gratitud por lo que Jesús ha hecho. Tus aportes sostienen la visión de la iglesia y extienden el mensaje de gracia en nuestra ciudad.
          </p>
        </div>
      </section>

      {/* OPCIONES DE DAR (Minimalismo Crudo) */}
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            
            {/* Opción 1: Transferencia Bancaria */}
            <div className="border border-eden-white/10 p-10 md:p-16 hover:bg-eden-white/5 transition-colors">
              <h2 className="font-serif-eden text-4xl mb-8">Transferencia Bancaria</h2>
            ...
            {/* Opción 2: Webpay / Online */}
            <div className="border border-eden-white/10 p-10 md:p-16 flex flex-col justify-between hover:bg-eden-white/5 transition-colors">
              <div>
                <h2 className="font-serif-eden text-4xl mb-6">Dar en Línea</h2>
                <p className="font-sans text-eden-stone/80 font-light leading-relaxed mb-10">
                  Puedes realizar tu aporte de manera rápida y segura utilizando tarjetas de débito o crédito a través de nuestro portal de pagos.
                </p>
              </div>
